...
Respond JSON: {{"target_role": "{target_role}","total_duration": "X months","milestones": [{{"week":"Week 1-2","title":"Foundation","tasks":["task1","task2"],"resources":[{{"name":"Course","url":"https://...","type":"course","cost":free/paid}}],"success_metric":"metric"}}],"key_certifications": [],"daily_commitment": "2-3 hours","motivational_message": "ข้อความให้กำลังใจภาษาไทย"}}"""
